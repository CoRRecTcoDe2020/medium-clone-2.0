...
const styles = {
  wrapper: `w-[70rem] h-[50rem] flex flex-col justify-start items-center gap-[1rem] p-[1rem] overflow-scroll`,
  ...
  accendButton: `bg-black text-white py-2 px-4 rounded-full`,
};
...
const PostModal = () => {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <button className={styles.accendButton} onClick={addPostToFirebase}>
        Submit
      </button>
    </div>
  );
