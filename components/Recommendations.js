...
import TutorialImage from "../static/tutorial.jpg";
...
const styles = {
  ...
  actionButton: `bg-[#1A8917] text-white rounded-full px-[.6rem] py-[.4rem] text-sm transition hover:opacity-90`,
  recommendationAuthorProfileImageContainer: `rounded-full overflow-hidden h-[1.4rem] w-[1.4rem]`,
  recommendationAuthorName: `text-sm`,
  recommendationAuthorContainer: `flex items-center gap-[.6rem]`,
  recommendationTitle: `font-bold`,
  recommendationThumbnailContainer: `flex flex-1 items-center justify-center h-[4rem] w-[4rem] ml-[1rem]`,
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.authorContainer}>
        ...
        <div className={styles.authorFollowing}>1M</div>
